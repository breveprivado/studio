...
import { CalendarIcon, Skull, Trophy, Pencil, Trash2, Upload, XCircle, Dumbbell, Zap, BrainCircuit, Heart, TrendingUp, TrendingDown, HelpCircle, TimerOff, History } from 'lucide-react';
...
const formSchema = z.object({
  ...
  isUnanalyzed: z.boolean().optional(),
  isNoTimerTrade: z.boolean().optional(),
  isPastPresentConfirmed: z.boolean().optional(),
  imageUrl: z.string().optional(),
  expirationTime: z.string().optional(),
  trendDirection: z.enum(['with-trend', 'counter-trend']).optional(),
});
...
const NewTradeDialog: React.FC<NewTradeDialogProps> = ({ isOpen, onOpenChange, onAddTrade, creatures }) => {
  ...
  const form = useForm<NewTradeFormValues>({
    ...
    defaultValues: {
      ...
      isWorstTrade: false,
      isUnanalyzed: false,
      isNoTimerTrade: false,
      isPastPresentConfirmed: false,
      imageUrl: '',
      expirationTime: '',
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Beneficio/Pérdida</FormLabel>
                    <FormControl>
            ...
            <div className="space-y-2">
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            <FormLabel className="flex items-center gap-2"><Zap className="h-4 w-4 text-yellow-500" />Expiración</FormLabel>
                            <FormControl>
                                <RadioGroup
                                    onValueChange={field.onChange}
                                    defaultValue={field.value}
            ...
            <FormField
                ...
                render={({ field }) => (
                    <FormItem>
                    <FormLabel>Dirección de Tendencia</FormLabel>
                    <FormControl>
                        <RadioGroup
                            onValueChange={field.onChange}
                            defaultValue={field.value}
                        ...
                        >
                            <FormItem>
                                <FormControl>
                                    <Label className={cn("inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input bg-background hover:bg-accent hover:text-accent-foreground h-9 px-3 cursor-pointer", field.value === 'with-trend' && 'bg-primary text-primary-foreground hover:bg-primary/90 hover:text-primary-foreground')}>
                                        <RadioGroupItem value="with-trend" className="sr-only" />
                            ...
                            <FormItem>
                                <FormControl>
                                     <Label className={cn("inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input bg-background hover:bg-accent hover:text-accent-foreground h-9 px-3 cursor-pointer", field.value === 'counter-trend' && 'bg-secondary text-secondary-foreground hover:bg-secondary/90')}>
                                        <RadioGroupItem value="counter-trend" className="sr-only" />
               ...
               <FormField
                ...
                <FormItem className="flex flex-row items-center space-x-3 space-y-0 rounded-md border p-4 shadow">
                    ...
                    <FormLabel className="flex items-center gap-2">
                        ...
                        Operación sin mirar el minutero
                    </FormLabel>
                    </div>
                </FormItem>
                )}
               ...
               <FormField
                ...
                <FormItem className="flex flex-row items-center space-x-3 space-y-0 rounded-md border p-4 shadow">
                    ...
                    <FormLabel className="flex items-center gap-2">
                        ...
                        Comparar Pasado, Confirmar Presente
                    </FormLabel>
                    </div>
                </FormItem>
                )}
